...
from . import streaks, heatmap, playbook_comparison
...
router.include_router(playbook_comparison.router, tags=["playbook-comparison"])
...
The only change is the `prefix` for `playbook_comparison.router` which should be `/playbooks` according to the edited snippet.

```
from fastapi import APIRouter
from . import heatmap, streaks, playbook_comparison
...
# Add playbook comparison router
router.include_router(playbook_comparison.router, prefix="/playbooks", tags=["playbook-comparison"])
```

	...
	const testimonials = [
		{
			name: 'Sarah Chen',
			role: 'Day Trader',
			content: 'TradeSense helped me identify my losing patterns. I\'ve improved my win rate by 23% in just 3 months.',
			avatar: '👩‍💼'
		},
		{
			name: 'Michael Rodriguez',
			role: 'Swing Trader',
			content: 'The analytics are incredible. I can finally see which strategies actually work for me.',
			avatar: '👨‍💻'
		},
		{
			name: 'Emma Thompson',
			role: 'Options Trader',
			content: 'Worth every penny. The AI insights alone have saved me thousands in avoided losses.',
			avatar: '👩‍🚀'
		}
	];
...
<div class="landing-page">
	...
	<section class="hero">
		<div class="hero-content">
			...
			<div class="hero-cta">
				...
				<button on:click={() => goto('#demo')} class="btn-secondary">
					Watch Demo
				</button>
			</div>
		...
		<div class="hero-visual">
			<div class="dashboard-preview">
				<img src="/images/dashboard-preview.png" alt="TradeSense Dashboard" />
			</div>
		</div>
	</section>
	...
	<section class="testimonials-section">
		<div class="container">
			<div class="section-header">
				<h2>Traders Love TradeSense</h2>
				<p>Join thousands improving their trading every day</p>
			</div>

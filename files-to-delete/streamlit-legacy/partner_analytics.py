...
class PartnerAnalyticsTracker:
    ...
    def get_partner_metrics(self, partner_id: str, days: int = 30) -> Dict:
        ...
        if not partner_id:
            return {
                'user_metrics': {'total_users': 0, 'active_users_week': 0, 'active_users_month': 0, 'new_users_week': 0},
                'revenue_metrics': {'total_revenue': 0, 'avg_revenue': 0, 'revenue_transactions': 0},
                'feature_usage': []
            }
        ...
        try:
            ...
            print(f"Error getting partner metrics: {e}")
            return {
                'user_metrics': {'total_users': 0, 'active_users_week': 0, 'active_users_month': 0, 'new_users_week': 0},
                'revenue_metrics': {'total_revenue': 0, 'avg_revenue': 0, 'revenue_transactions': 0},
                'feature_usage': []

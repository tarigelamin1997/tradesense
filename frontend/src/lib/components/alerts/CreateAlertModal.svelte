...
<style>
    ...
    .step {
        @apply w-8 h-8 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center font-medium transition-colors;
    }
    ...
    .step-line {
        @apply w-16 h-0.5 bg-gray-200 transition-colors;
    }

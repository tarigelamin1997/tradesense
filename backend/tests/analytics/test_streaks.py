...
class TestStreakAnalytics:
    ...
    def test_find_max_win_streak_details(self):
        ...
        result = find_max_win_streak(trades)
    ...
    def test_find_max_loss_streak_details(self):
        ...
        result = find_max_loss_streak(trades)
    ...
    def test_get_current_streak(self):
        ...
        trades = [
            MockTrade(100, 0),   # win
            MockTrade(-50, 1),   # loss
            MockTrade(150, 2),   # win (start of current streak)
            MockTrade(200, 3)    # win (current streak continues)
        ]
        
        result = get_current_streak(trades)
        
        assert result['type'] == 'win'
        assert result['length'] == 2
        assert result['pnl'] == 350  # 150 + 200
